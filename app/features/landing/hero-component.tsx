export function HeroComponent() {
  return (
    <div className="max-w-2xl">
      <h2 className="text-foreground text-4xl leading-10 font-bold tracking-tight">
        <b className="text-primary">You</b> can become a senior fullstack
        developer.
      </h2>

      <p className="text-muted-foreground mt-6 mb-3 font-bold">
