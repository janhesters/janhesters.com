...
> ❗️ Note: There is a newer article that is more up to date and includes better examples & techniques. [How To Unit Test Reducers](https://janhesters.com/blog/how-to-unit-test-reducers).
