...
If your comment is a one-liner or a short description of the function, and it differs from the function's name, that might be a code smell indicating the function is misnamed.
