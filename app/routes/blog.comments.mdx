...
The following code was from a real code base. It contained a `NotificationPanelMetaData` model that contained the settings and notifications for the notification panel, which pops up if you click the bell in the top right corner.
