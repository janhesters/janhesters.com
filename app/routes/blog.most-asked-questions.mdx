...
You should know that "Mocking Is A Code Smell", but that is a topic for another video. So in this tutorial you're going to use a setup function.
...
React Testing Library is used together with Jest or Vitest to write functional tests for your React components. And you mock the DOM using JSDom or Happy DOM. You will learn how to install those and use React Testing Library later in this video.

An E2E test framework like Playwright or Cypress use an actual browser to visit your app and then interact with it.

So RTL runs faster than E2E test frameworks, but E2E test frameworks give you more confidence that your app works as expected.
...
Jest is a test runner. It provides helper functions so you can write tests, and executes those functions for you when you run your tests. This tutorial uses Vitest because it has the same API as Jest, but runs faster. Everything you learn in this video is applicable to Jest.
...
You should use React Testing Library (RTL), too. With RTL you can simulate user interactions.
...
**Note to Editors:** Maybe insert Noah Penguin / Elefent meme / gif / screenshot here: https://www.youtube.com/watch?v=t_5XkPh3vXg

Elephant on body has "unit test" penguin has "functional test". (Good screengrab is [here](https://imgflip.com/memegenerator/167618150/Family-guy-Noahs-ark))
