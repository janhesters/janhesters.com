...
export const meta = createPostMetaData({
  ...
  title: 'TypeScript HOC and Decorators in React',
  type: 'archived',
});
...
**Note:** This post is targeted at intermediates and a follow up of my beginner-friendly post ["How To Add a Badge to Icons in React Native"](/how-to-add-a-badge-to-icons-in-react-native), where you can learn about HOCs in regular JavaScript.
...
As an example, I'm going to use an icon in a tab bar. If you want to see other use cases, check out [my previous article](/how-to-add-a-badge-to-icons-in-react-native).

The end result is going to look like this 😍:

!['Inspired by WhatsApp 💬 '](images/footer.png)
...
First, we need to create an app with TypeScript. Follow the instructions [here](/using-typescript-with-react-native)¹, but leave out the testing setup.
