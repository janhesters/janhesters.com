...
export const meta = createPostMetaData({
  date: '2019-07-09',
  description: 'Arrow functions are implicitly returning function expressions without `this`.',
  id: 'ckchzar3200003ojo6haeg3xm',
  tags: ['javascript', 'arrow functions', 'beginner', 'difference'],
...
If you liked this article, you might also like ["Conditional Rendering"](/conditional-rendering) because we explore `||` and `&&` in it in-depth.
