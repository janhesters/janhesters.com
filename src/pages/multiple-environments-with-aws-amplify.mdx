...
We might want to [track our users using Amplify's analytics](/tracking-and-email-reminders-in-aws-amplify/), so let's add that to our `dev` branch.
...
If you liked this tutorial, you might want to read [my other articles about Amplify](/archive) because they cover advanced use cases and make you an Amplify expert.
