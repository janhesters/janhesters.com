...
After my last article ["Setting Up a Project with CI/CD Using Amplify"](/setting-up-a-project-with-ci-cd-using-amplify/), I've been asked how I write E2E tests for Amplify apps. My first answer was "like you always do." But I guess people are having trouble with their setup and teardown for functional tests.
...
**Note:** This article only covers UI tests. If you want to test Lambda functions, you can learn the tricks I use to test (and write more modular) Lambda functions. Read ["Testing Lambda Functions (feat. Amplify)"](/testing-lamba-functions/) because it explains these concepts in-depth.
...
If you enjoyed this article, you might want to read ["How to Access the User in Lambda Functions (with Amplify)"](/how-to-access-the-user-in-lambda-functions-with-amplify/) because, alongside E2E testing, it is an essential skill for every Amplify developer.
