...
export const meta = createPostMetaData({
  date: '2020-08-22',
  description: 'Tests should be isolated, composable, fast, inspiring, writable, readable, behavioral, structure-insensitive, automated, specific, deterministic and predictive. These desirable properties are trade-offs.',
  id: 'cke628qjz000039jo67s9a2h1',
  tags: ['test', 'desiderata', 'properties', 'unit-testing', 'testing', 'riteway', 'kent', 'beck', 'kelly', 'sutton', 'jest', 'javascript'],
...
The examples Ken and Kelly give are in Ruby. In this article, I translate those examples into JavaScript. I use [RITEway](https://github.com/ericelliott/riteway) for the examples because of its genius API that forces you to write good tests and once [Jest](https://jestjs.io/), where RITEway prohibits you from writing bad tests. I highly encourage you to watch Ken's and Kelly's playlist in addition to reading this article - even if you, like me, don't know Ruby. Their explanations are fun and enlightening. Consider this article a TL;DW with additions from me and a translation into JavaScript.
...
> "If I can't test it, I designed it wrong." - [Kent Beck](https://youtu.be/CAttTEUE9HM)
...
I used a different example than Ken and Kelly, but you want to [watch their video](https://youtu.be/PwWyp-wpFiw), too, because their example visualizes the problem excellently for E2E tests.
