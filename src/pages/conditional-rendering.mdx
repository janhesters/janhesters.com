...
export const meta = createPostMetaData({
  date: '2019-07-02',
  description: '|| and && (often) don\'t return booleans. You need to learn about the operand selector operators, which return either their left or right argument to understand conditional rendering in React.',
  id: 'ckcj6b2pm0000z2joezus5bof',
...
If you liked this article you might also like ["useCallback vs. useMemo"](/usecallback-vs-usememo) where we explore the differences between the two Hooks or the more beginner friendly post: ["Arrow Functions."](/arrow-functions)
