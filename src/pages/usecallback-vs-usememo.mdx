...
export const meta = createPostMetaData({
  date: '2019-05-14',
  description: 'With useCallback you can define a function that has referential equality between renders. You can use useMemo to calculate a value that has referential equality between renders. Both only change their return value when their dependencies change.',
  ...
  tags: ['react', 'hooks', 'useCallback', 'useMemo', 'vs', 'difference'],
...
Since JavaScript has [first-class functions](https://developer.mozilla.org/en-US/docs/Glossary/First-class_Function), 
